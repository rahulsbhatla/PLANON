...
public class Database {
	...
	public void data() {
		...
		ContractEmployee c1 = new ContractEmployee(005, "kapil", "contract", address5, date5);
		addEmployee(c1);
		Address address6 = new Address("houseno:606", "Himayatnagar", 500044);
		Date date6 = new Date(28, 10, 2020);
		
		ContractEmployee c2 = new ContractEmployee(006, "Ravi", "contract", address6, date6);
		addEmployee(c2);
		Address address7 = new Address("houseno:2202", "Gandhinagar", 500044);
		Date date7 = new Date(31, 03, 2021);
	
		ContractEmployee c3 = new ContractEmployee(007, "Prabhat", "contract", address7, date7);
		addEmployee(c3);
