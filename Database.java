...
public class Database {
	...
	public void data() {
		...
		ContractEmployee c1 = new ContractEmployee(005, "kapil", "contract", address5, date5,leave5,20);
		addEmployee(c1);
		...
		ContractEmployee c2 = new ContractEmployee(006, "Ravi", "contract", address6, date6,leave6,18);
		addEmployee(c2);
		...
		ContractEmployee c3 = new ContractEmployee(007, "Prabhat", "contract", address7, date7,leave7,22);
		addEmployee(c3);
	...
	public Employee printEmployeeDetails2(int eid) {
		for (Employee e : EmployeeList) {
			if (e.getId() == eid) {
				e.display3();
				return e;
